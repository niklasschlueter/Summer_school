...
def main():
    ...
    def run_expert(data_dir="runs_7", episodes=1):
    ...
    def run_policy(data_dir="runs_7", episodes=1, move_to_start_position=False):
        planner.set_current_ft_measuerements_as_zero()
    ...
    try:
        ...
        run_expert(data_dir="runs_7", episodes=1)
        print(f"running policy")
        run_policy(data_dir="runs_7", episodes=1)
